...
> **⚠️ 修改说明（2026-06-15）：** 美伊停火协议达成（6月19日生效，霍尔木兹重开）。本文结论"这个循环没有干净出口"需修正——停火是第一个"出口"：油价暴跌→通胀下降→加息预期消退→沃什'缩表降息'框架变得可行。但$39万亿债务、美元信用侵蚀等问题未解，属于"部分出口"。详见[《沃什降息缩表+美伊停火：宏观格局突变》](/analysis/warsh-ceasefire-macro-impact/)。
