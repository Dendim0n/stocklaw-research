+++
title = "Factor Lab 每日速报 2026-08-15"
date = 2026-08-15
description = "2026年8月15日 Factor Lab 每日因子检验报告。动量因子 ICIR 2.70 持续主导全市场，信息技术行业动量 ICIR 2.58、Q5 月均收益 +27.19% 极端分化；FCF 收益率因子 ICIR -1.43 为最强价值信号，EP 因子 ICIR -0.74 反转持续；BP 因子失效 ICIR 仅 0.08；医疗保健行业动量反转 ICIR -1.21。因子数据与上一交易日完全持平，TTM 财务面板处于季中静默期，价格缓存未更新。"
+++
