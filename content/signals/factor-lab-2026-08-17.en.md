...
![Factor IC](/charts/factor-ic-2026-08-17.png)
...
| Sector | Sample | IC Mean | ICIR | IC Positive % | Q5 Monthly Return | Q1 Monthly Return | Long-Short (Monthly) |
|--------|--------|---------|------|---------------|-------------------|-------------------|----------------------|
...
![Sector Momentum](/charts/sector-mom-2026-08-17.png)
