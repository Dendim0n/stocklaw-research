---
title: "Factor Lab Daily Brief 2026-06-08"
description: "Momentum dominates (IC=0.224, ICIR 2.70); reversal signals strengthen — EP/FCF Yield negative; IT sector momentum IC 0.52 leads"
date: 2026-06-08
---
...
1. **Trend following remains effective**: Momentum factor IC 2.70 + 100% positive rate — long strong / short weak continues to work.
2. **Watch for crowding**: When momentum IC exceeds 0.2 with ICIR > 2.5, markets often approach late-stage single-direction moves. Monitor reversal risk.
3. **Tech concentration risk**: IT Q5 +27% monthly is an extreme reading — trend reversals could produce violent drawdowns.
4. **Health Care as potential rotation signal**: Strongest momentum reversal in the sector, may be a leading indicator of style rotation.
