...
date: 2026-06-04
description: "Gemini Deep Research 关于 Magnificent 7 估值与盈利增速的研报，经 StocKlaw 用 Longbridge + yfinance 实际数据交叉验证后的完整分析"
...
| 股票 | Longbridge FWD PE | yfinance FWD PE | Gemini研报 | Longbridge EPS增速 | yfinance EPS增速 |
|------|-------------------|-----------------|-----------|-------------------|------------------|
...
| 股票 | Longbridge 滚动4Q增速 | yfinance 增速 | 差异 |
|------|----------------------|--------------|------|
| NVDA | +34.9% | — | — |
| MSFT | +5.7% | +23.4% | 4倍 |
| META | +6.8% | +62.4% | 9倍 |
